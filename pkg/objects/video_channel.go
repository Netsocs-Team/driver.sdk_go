...
const VIDEO_CHANNE_ACTION_VIDEOCLIP = "video_channel.action.videoclip"
...
func (v *videoChannelObject) GetAvailableActions() []ObjectAction {
	return []ObjectAction{
		...
		{Action: VIDEO_CHANNE_ACTION_VIDEOCLIP, Domain: v.metadata.Domain},
	}
}
...
func (v *videoChannelObject) RunAction(action string, payload []byte) error {
	...
	case VIDEO_CHANNE_ACTION_VIDEOCLIP:
